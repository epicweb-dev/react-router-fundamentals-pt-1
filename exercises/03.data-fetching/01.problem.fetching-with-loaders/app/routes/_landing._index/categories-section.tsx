...
// 💣 We don't need these categories anymore! Let's remove them!
const categories = [
	{
		name: 'Running',
		imageUrl:
...
// 🐨 Use the categories provided to the component instead of the hardcoded ones
export const CategoriesSection = ({}: { categories: Category[] }) => {
	return (
