...
export function ProductFilters({ isPageLoading }: ProductFiltersProps) {
	...
	//  💰 We learned how to get single values from the url
						...
						{loaderData.categories.map((category) => (
							<div key={category.id} className="flex items-center">
								<input
									...
									// 🐨 let's apply the default checked if the url includes the category
									defaultChecked={
										// 💰 searchParams has a getAll method that returns an array of values
										undefined
									}
									name="category"
									value={category.name}
